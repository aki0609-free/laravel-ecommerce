          ...
          <section class="text-gray-600 body-font">
            <div class="container md:px-5 mx-auto">
              ...
              <div class="flex justify-end mb-4">
                <button onClick="location.href='{{ route('admin.owners.create') }}'" class="bg-gray-200 border-0 py-2 px-8 focus:outline-none hover:bg-gray-400 rounded text-lg">REGISTER AS A OWNER</button>
              </div>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="md:px-4 py-3">
                        <button onClick="location.href='{{ route('admin.owners.edit', ['owner' => $owner->id]) }}'" class="bg-gray-200 border-0 py-2 px-4 focus:outline-none hover:bg-gray-400 rounded">EDIT</button>
                      </td>
                      <form id="delete_{{$owner->id}}" method="post" action="{{ route('admin.owners.destroy', ['owner' => $owner->id]) }}">
                        @csrf
                        @method('delete')
                        <td class="md:px-4 py-3">
                          <a href="#" data-id="{{ $owner->id }}" onClick="deletePost(this)" class="bg-red-200 border-0 py-2 px-4 focus:outline-none hover:bg-red-400 rounded">DELETE</a>
                        </td>
                      </form>
                    </tr>
                    @endforeach
