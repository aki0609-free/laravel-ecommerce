                ...
                <table class="table-auto w-full text-left whitespace-no-wrap">
                  <thead>
                    <tr>
                      ...
                      <th class="px-4 py-3 title-font tracking-wider font-medium text-gray-900 text-sm bg-gray-100">Deleted_at</th>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <form id="delete_{{$owner->id}}" method="post" action="{{ route('admin.expired-owners.destroy', ['owner' => $owner->id]) }}">
                        @csrf
                        <td class="px-4 py-3">
                          <a href="#" data-id="{{ $owner->id }}" onClick="deletePost(this)" class="bg-red-200 border-0 py-2 px-4 focus:outline-none hover:bg-red-400 rounded">DELETE COMPLETELLY</a>
                        </td>
                      </form>
                    </tr>
                    @endforeach
